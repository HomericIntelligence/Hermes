...
WORKDIR /build
# requirements.txt is generated by scripts/sync_requirements.py from pixi.lock —
# exact lock-pinned versions, not ranges. Regenerate with: just sync-reqs
# The check-reqs CI gate (docker-deps job) ensures this file stays in sync.
